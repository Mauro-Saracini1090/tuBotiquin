                    ...
                    <div class=" col-lg-2 col-12 mx-0 my-5">
                        <ul class="list-group list-group-flush">
                            {{-- <li class="list-group-item ">
                                <h6 class="masthead-subheading">FARMACIA</h6>
                                <div class="d-flex d-flex justify-content-left pb-2 ml-3">
                                    <a href="{{ route('farmacia.create') }}"> <i class=" Medium material-icons "
                                            style="font-size: 40px" data-toggle="tooltip" data-placement="left"
                                            title="Agregar nueva Farmacia">add_box</i></a>
                                    <a href="{{ route('verfarmacia') }}"><i class="material-icons" style="font-size: 42px"
                                            data-toggle="tooltip" data-placement="left" title="Ver Farmacia">pageview</i></a>
                                    <div>
                            </li> --}}
                            <li class="list-group-item">
                            ...
                            {{-- <li class="list-group-item">
                                ...
                                <div class="d-flex d-flex justify-content-left pb-2 ml-3">
                                    <a href="{{ route('obrasocial.index') }}"><i class="material-icons"
                                            style="font-size: 40px">pageview</i></a>
                                    <a href="{{ route('obrasocialfarmacia') }}"><i class="material-icons"
                                            style="font-size: 40px">add_box</i></a>
