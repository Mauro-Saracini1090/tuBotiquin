                ...
                <div class="shadow p-3 mb-5 bg-white"> 
                       ...
                       <!-- Descripcion -->
                        <div class="form-group">
                            ...
                            <textarea  name="descripcion_sucursal" class="form-control is-invalid @error('descripcion_sucursal')  @enderror"
                        ...
                        <!-- Cufe -->
                         <div class="form-group">
                            ...
                            <input type="text" name="cufe_sucursal" value="{{ old('cufe_sucursal') }}" class="form-control @error('cufe_sucursal') is-invalid @enderror" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email_sucursal" value="{{ old('email_sucursal') }}" placeholder="correo@ejemplo.com" class="form-control @error('email_sucursal') is-invalid @enderror" required>
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" name="telefono_sucursal" value="{{ old('telefono_sucursal') }}" placeholder="Ejemplo: 29844586958" class="form-control @error('telefono_sucursal') is-invalid @enderror" required>
                            <small  class="form-text text-muted">Sin espacios ni guiones, 8 dígitos mínimo</small>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="direccion_sucursal" value="{{ old('direccion_sucursal') }}" placeholder="Ejemplo: Entre Av. Libertad y San Martin n° 154" class="form-control @error('direccion_sucursal') is-invalid @enderror" required>
