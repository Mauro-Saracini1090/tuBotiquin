    ...
    <div class="row justify-content-center">
        <div class=" col-12">
            <div class="shadow p-3 mb-5 backCard rounded">
                <!-- Masthead Subheading-->
                <h3 class="masthead-subheading text-center">Editar Medicamento</h3>
                ...
                <form method="POST" action="{{ route('medicamentos.update',[$medicamento]) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('nombre_medicamento') is-invalid @enderror" type="text"
                            name="nombre_medicamento" value="{{ old('nombre_medicamento', $medicamento->nombre_medicamento) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('informacion') is-invalid @enderror" name="informacion"
                            type="textarea" placeholder="¡Aqui puede colocar las Informacion del Medicamento"
                    name="informacion">{{$medicamento->informacion}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select id="id_tipo" class="form-control @error('id_tipo') is-invalid @enderror"
                            ...
                            @foreach($tipos as $tipo)
                                <option value="{{ $tipo->id_tipo }}" @if($medicamento->tipo_id == $tipo->id_tipo) selected @endif>{{ $tipo->nombre_tipo }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="id_marca" class="form-control @error('id_marca') is-invalid @enderror"
                            ...
                            @foreach($marcas as $marca)
                                <option value="{{$marca->id_marca}}" @if($medicamento->marca_id == $marca->id_marca) selected @endif>{{ $marca->nombre_marca }}</option>
                            @endforeach
                        </select>
