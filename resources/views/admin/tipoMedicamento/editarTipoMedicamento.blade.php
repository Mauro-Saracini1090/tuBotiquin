...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-2 border-bottom">
    ...
    <form class="form-signin" method="post" action="{{route('tipoMedicamentos.update',[$tipoMedicamento]) }}">
        @csrf
        @method('PATCH')
        <div class="form-group">
            ...
            <input class="form-control @error('nombre_tipo') is-invalid @enderror" type="text" name="nombre_tipo" id="nombre_tipo" placeholder="Nombre Tipo Medicamento"
                value="{{ old('nombre_tipo', $tipoMedicamento->nombre_tipo )}}">
        </div>
        <div class="form-group">
        ...
        <a href="{{ route('tipoMedicamentos.index') }}" class="btn btn-secondary mx-1">Volver Atras</a>
    </form>
@endsection