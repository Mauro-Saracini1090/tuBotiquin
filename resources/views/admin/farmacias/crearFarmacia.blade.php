                ...
                <form method="POST" action="{{ route('almacenarFarmaciaAdmin') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre_farmacia"
                            ...
                            @error('nombre_farmacia') is-invalid @enderror required class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="img_farmacia"
                            value="{{ old('img_farmacia') }}"
                            @error('img_farmacia') accept="image/*" is-invalid @enderror class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="descripcion_farmacia" type="textarea"
                            placeholder="¡Aqui puede colocar el eslogan de su Farmacia!" @error('descripcion_farmacia')
                            is-invalid @enderror
                            name="descripcion_farmacia">{{ old('descripcion_farmacia') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="cuit"
                            value="{{ old('cuit') }}" @error('cuit')
                            is-invalid @enderror required class="form-control">
