...
<div class="row mt-2">
    <div class="col align-bottom">
        <span class="align-bottom"><h3 class="">Informacion de Farmacia {{ $farmacium->nombre_farmacia }}</h3></span>
...
<table class="table table-dark">
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $farmacium->usuarioFarmaceutico->nombre }} {{ $farmacium->usuarioFarmaceutico->apellido }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><img class="img-thumbnail rounded float-left" src="{{ URL::to('/') }}{{ $farmacium->img_farmacia }}" alt="{{ $farmacium->nombre_farmacia }}" width="200px"></td>
        </tr>
        <tr>
