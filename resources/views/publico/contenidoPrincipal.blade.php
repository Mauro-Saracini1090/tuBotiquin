        ...
        @if(count($sucursalesTurno) < 1)
            ...
            <div class="col-12">
                <div class="p-3 mb-2 bg-warning rounded shadow text-dark text-center mx-auto">
                    <h6 class="mb-2">
                        No existen Farmacias de turnos para el día <ins><?php echo date('d-m-Y') ?> </ins> registradas
                        en la plataforma.
                    </h6>
                    <br>
                ...
                <div class="shadow  p-3 mb-4  bg-white rounded">
                    <div class="row">
                        <div class="col-8 my-auto text-center">
                            <h2 class="card-title">
                                <?php echo strtoupper($sucursalesTurno[0]->getFarmacia->nombre_farmacia ) ?></h2>
                            <p> <?php echo $sucursalesTurno[0]->getFarmacia->descripcion_farmacia ?> </p>
                        </div>

                        <div class="col-md-3 col-12">
                            <div class="d-flex d-flex justify-content-center">
                                <img class="card-img-top shadow img-rounded img-fluid"
                                    src="{{ URL::to('/') }}{{ $sucursalesTurno[0]->getFarmacia->img_farmacia }}"
                                    alt="{{ $sucursalesTurno[0]->getFarmacia->nombre_farmacia }}" width="150"
                                    height="150">
                                <hr>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><i class="material-icons">location_on</i> Dirección: <span
                                    class="font-weight-bold text-secondary">{{ $sucursalesTurno[0]->direccion_sucursal }}
                                </span></li>
                            <li class="list-group-item"><i class="material-icons">mail</i> Email: <span
                                    class="font-weight-bold text-secondary">{{ $sucursalesTurno[0]->email_sucursal }}
                                </span></li>
                            <li class="list-group-item"><i class="material-icons">local_phone</i> Teléfono: <span
                                    class="font-weight-bold text-secondary">{{ $sucursalesTurno[0]->telefono_sucursal }}
                                </span></li>
                        </ul>
                        <hr>
                        <div class="d-flex d-flex justify-content-center">
                            <form method="POST" action="{{ route('verSucursalTurnoHoy') }}">
                                ...
                                <input type="hidden" name="id_sucursal"
                                    value={{ $sucursalesTurno[0]->id_sucursal }}>
                        ...
                        <div class="shadow  p-3 mb-4  bg-white rounded">
                            <div class="row">
                                <div class="col-md-8 col-12 my-auto text-center">
                                    <h2 class="card-title">
                                        <?php echo strtoupper($sucursal->getFarmacia->nombre_farmacia ) ?></h2>
                                    <p> <?php echo $sucursal->getFarmacia->descripcion_farmacia ?> </p>
                                </div>

                                <div class="col-md-4 col-12">
                                    <img class="card-img-top shadow img-rounded"
                                        src="{{ URL::to('/') }}{{ $sucursal->getFarmacia->img_farmacia }}"
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><i class="material-icons">location_on</i> Dirección:
                                        <span class="font-weight-bold text-secondary">
                                            {{ $sucursal->direccion_sucursal }} </span></li>
                                    <li class="list-group-item"><i class="material-icons">mail</i> Email: <span
                                            class="font-weight-bold text-secondary">{{ $sucursal->email_sucursal }}
                                        </span></li>
                                    <li class="list-group-item"><i class="material-icons">local_phone</i> Teléfono:
                                        <span class="font-weight-bold text-secondary">
                                            {{ $sucursal->telefono_sucursal }} </span></li>
                                </ul>
                                <hr>
                                <div class="d-flex d-flex justify-content-center">
                                    <form method="POST" action="{{ route('verSucursalTurnoHoy') }}">
    ...
    <div class="row">
        @if(count($arrSucursalesTurnoSiguiente) == 0)
            ...
            <div class="col-12">
                <div class="p-3 mb-2 bg-warning rounded shadow text-dark text-center mx-auto">
                    <h6 class="mb-2">
                        No existen Farmacias de turnos para los siguientes días registradas en la plataforma en este
                        momento
                    </h6>
                    <br>
                    <p>Disculpe las Molestias. <strong>Equipo tuBotiquín</strong></p>
                ...
                <div class="p-3 mb-4 shadow bg-white rounded">
                    ...
                    <div class="card-body">
                        <h4 class="card-title text-center">
                            <?php echo strtoupper($sucursal->getFarmacia->nombre_farmacia) ?></h4>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><i class="material-icons">location_on</i> Dirección: <span
                                    class="font-weight-bold text-secondary">{{ $sucursal->direccion_sucursal }}</span>
                            </li>
                            <li class="list-group-item"><i class="material-icons">mail</i> Email: <span
                                    class="font-weight-bold text-secondary">{{ $sucursal->email_sucursal }} </span>
                            </li>
                            <li class="list-group-item"><i class="material-icons">local_phone</i> Teléfono: <span
