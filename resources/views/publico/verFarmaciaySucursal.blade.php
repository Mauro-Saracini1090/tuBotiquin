                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="p-3 mb-2 bg-warning text-dark">
                                    <h6 class="font-weight-bold text-center"><i class="large material-icons align-middle mx-1" style="font-size: 40px">warning</i> Atención - Esta Farmacia no posee sucursales cargadas</h6>
                                </div>
                            </div>
                    </div>        
                    @endif
