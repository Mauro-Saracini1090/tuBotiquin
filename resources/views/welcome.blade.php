    ...
    <div
        ...
        @if(Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                <a href="{{ route('permisos.index') }}" class="text-sm text-gray-700 underline">Permisos</a>
                <a href="{{ route('roles.index') }}" class="text-sm text-gray-700 underline">Roles</a>
                <a href="{{ route('usuario.index') }}" class="text-sm text-gray-700 underline">Usuarios</a>
                @auth
